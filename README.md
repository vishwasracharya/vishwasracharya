...
- [Blogging](https://vishwasracharya.github.io/blog) with the similar concept like podcast, but in the form of written content. Also I started creating [Tech Blogs](https://vishwasacharya.hashnode.dev/) through Hashnode, which has <strong><em>1.1K+ Reads</em></strong>.
